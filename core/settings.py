...
CSRF_TRUSTED_ORIGINS = ['https://boxcart-1.onrender.com']
...
# Where your source static files are
STATICFILES_DIRS = [
...
EMAIL_PORT=587
EMAIL_HOST_USER='sahooabhinav0@gmail.com'
EMAIL_HOST_PASSWORD='asbv uzpv ccdz ynbb'
EMAIL_USE_TLS=True